...
Migration 007 применена и проверена в Supabase для текущего milestone. Runbook
сохранён как процедура аудита и будущего чистого развёртывания. Все действия
выполняются в согласованное окно владельцем Supabase-проекта. Не вставляйте
service role key, токены или пользовательские данные в команды, скриншоты и
отчёт.
