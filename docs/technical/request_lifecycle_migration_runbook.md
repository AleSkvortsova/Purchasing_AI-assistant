...
Migration 008 применена и проверена в Supabase для текущего milestone. Runbook
сохранён как процедура аудита и будущего чистого развёртывания; миграция не
применяется приложением автоматически. Не помещайте service role key, токены,
персональные данные или полный payload заявки в команды и отчёты.
