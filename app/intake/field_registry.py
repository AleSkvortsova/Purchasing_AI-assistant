...
CATEGORY_TAXONOMY_VERSION = "intake-categories-v2"
CATEGORY_DESCRIPTIONS = {
    ...
    "G03": "Компьютеры, серверы и основные вычислительные устройства.",
    ...
    "G14": "Электротехнические изделия, материалы и компоненты.",
    "G15": "Инженерные детали, компоненты и запчасти для оборудования.",
    "S01": (
