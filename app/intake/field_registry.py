...
CATEGORY_NAMES = {
    ...
    "G15": "Инженерное оборудование и запчасти",
...
# Semantic metadata for closed-taxonomy classification. Codes and display names
# remain canonical in CATEGORY_NAMES; the descriptions explain category meaning
# without trying to enumerate every possible procurement item.
CATEGORY_TAXONOMY_VERSION = "intake-categories-v3"
CATEGORY_DESCRIPTIONS = {
    "G01": "Расходные принадлежности для повседневной офисной работы.",
    "G02": "Мебель и оснащение рабочих, переговорных и общих помещений.",
    "G03": (
        "Основные вычислительные и инфраструктурные IT-устройства: компьютеры, "
        "серверы и сетевое оборудование."
    ),
    "G04": "Периферийные устройства и аксессуары для компьютерных рабочих мест.",
    "G05": "Готовое программное обеспечение, лицензии и подписки.",
    "G06": "Оборудование для хранения и организации складских операций.",
    "G07": "Погрузочная техника, её узлы и специализированные запчасти.",
    "G08": "Спецодежда и средства индивидуальной защиты работников.",
    "G09": "Хозяйственные товары и принадлежности для уборки и быта.",
    "G10": "Материалы и изделия для упаковки и защиты грузов.",
    "G11": "Готовая печатная и полиграфическая продукция.",
    "G12": "Рекламные конструкции, POS-материалы и материалы оформления.",
    "G13": "Сувениры, мерч и подарочная продукция.",
    "G14": (
        "Материалы и типовые компоненты электрической инфраструктуры, не "
        "являющиеся самостоятельным производственным оборудованием."
    ),
    "G15": (
        "Самостоятельное инженерное и промышленное оборудование, а также его "
        "детали, компоненты и запчасти."
    ),
    "S01": (
        "Работы непосредственно с объектом или оборудованием: ремонт, монтаж, "
        "техническое или регламентное обслуживание и восстановление "
        "работоспособности."
    ),
    "S02": "Уборка помещений и профессиональный клининг.",
    "S03": "Перевозка, доставка и иные транспортные услуги.",
    "S04": "Ответственное хранение и иные складские услуги.",
    "S05": "Разработка, интеграция, настройка и поддержка IT-систем.",
    "S06": "Маркетинговые исследования, продвижение и рекламные услуги.",
    "S07": "Дизайн, фото, видео и создание контента.",
    "S08": "Подготовка и проведение мероприятий.",
    "S09": "Обучение, тренинги и образовательные программы.",
    "S10": "Поиск, оценка и подбор персонала.",
    "S11": "Юридические, консультационные и аудиторские услуги.",
    "S12": "Письменный и устный перевод.",
    "S13": "Печать и изготовление полиграфической продукции как услуга.",
    "S14": "Аренда имущества и оборудования.",
    "S15": (
        "Специализированные профессиональные или технические услуги, которые не "
        "являются ремонтом, монтажом или техническим обслуживанием: "
        "метрологические, поверочные, калибровочные, испытательные и экспертные "
        "работы."
    ),
}

if set(CATEGORY_DESCRIPTIONS) != set(CATEGORY_NAMES):
    raise RuntimeError("Category taxonomy metadata is incomplete")
