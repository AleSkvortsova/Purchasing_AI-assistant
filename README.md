...
создания, чтения и частичного обновления черновика.
...
LLM/RAG и авторизация конечных пользователей. Перед реальным пилотом необходимо
включить RLS и определить политики минимальных прав.
