...
Многосоставные вопросы могут использовать несколько нормативных источников.
Русские числительные, форматы сумм и подтверждённые формулировки бюджетного
статуса приводятся к единому виду. Если для маршрута согласования не указан
бюджетный статус, Q&A задаёт отдельный уточняющий вопрос вместо общего отказа.
